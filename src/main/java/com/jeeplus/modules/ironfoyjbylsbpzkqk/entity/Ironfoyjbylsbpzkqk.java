 ...
 */
package com.jeeplus.modules.ironfoyjbylsbpzkqk.entity;
 ...
 * @version 2018-03-22
 */
public class Ironfoyjbylsbpzkqk extends DataEntity<Ironfoyjbylsbpzkqk> {
	...
	public Ironfoyjbylsbpzkqk() {
		super();
	}

	public Ironfoyjbylsbpzkqk(String id){
		super(id);
	}
