 ...
 * @version 2018-04-08
 */
public class Ironfoinformationsxjkxxfw extends DataEntity<Ironfoinformationsxjkxxfw> {
	...
	public Ironfoinformationsxjkxxfw() {
		super();
	}

	public Ironfoinformationsxjkxxfw(String id){
		super(id);
	}
