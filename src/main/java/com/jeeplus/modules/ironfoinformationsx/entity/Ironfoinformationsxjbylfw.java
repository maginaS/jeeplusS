 ...
 * @version 2018-04-08
 */
public class Ironfoinformationsxjbylfw extends DataEntity<Ironfoinformationsxjbylfw> {
	...
	public Ironfoinformationsxjbylfw() {
		super();
	}

	public Ironfoinformationsxjbylfw(String id){
		super(id);
	}
