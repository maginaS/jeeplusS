 ...
 */
package com.jeeplus.modules.ironfofivebfpz.entity;
 ...
 * @version 2018-04-08
 */
public class Ironfofivebfpz extends DataEntity<Ironfofivebfpz> {
	...
	public Ironfofivebfpz() {
		super();
	}

	public Ironfofivebfpz(String id){
		super(id);
	}
