 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzwkfckreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzwkfckReport extends DataEntity<IronfoyjbylsbpzwkfckReport> {
	...
	public IronfoyjbylsbpzwkfckReport() {
		super();
	}

	public IronfoyjbylsbpzwkfckReport(String id){
		super(id);
	}
