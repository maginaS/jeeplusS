 ...
 */
package com.jeeplus.modules.report.ironfo_yjbylsbpz_pfk_report.entity;
 ...
 * @version 2018-04-20
 */
public class Ironfo_yjbylsbpz_pfk_Report extends DataEntity<Ironfo_yjbylsbpz_pfk_Report> {
	...
	public Ironfo_yjbylsbpz_pfk_Report() {
		super();
	}

	public Ironfo_yjbylsbpz_pfk_Report(String id){
		super(id);
	}
