 ...
 * @version 2018-04-20
 */
public class IronfodepartmentremarkReport extends DataEntity<IronfodepartmentremarkReport> {
	...
	public IronfodepartmentremarkReport() {
		super();
	}

	public IronfodepartmentremarkReport(String id){
		super(id);
	}
