 ...
 */
package com.jeeplus.modules.report.ironfozybreport.entity;
 ...
 * @version 2018-04-19
 */
public class IronfozybReport extends DataEntity<IronfozybReport> {
	...
	public IronfozybReport() {
		super();
	}

	public IronfozybReport(String id){
		super(id);
	}
