 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzsssreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzsssForExcelReport extends DataEntity<IronfoyjbylsbpzsssForExcelReport> {
	...
	public IronfoyjbylsbpzsssForExcelReport() {
		super();
	}
	public List<IronfoyjbylsbpzsssReport> IronfoyjbylsbpzsssReportList;
	public IronfoyjbylsbpzsssForExcelReport(String id){
		super(id);
	}
