 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzsssReport extends DataEntity<IronfoyjbylsbpzsssReport> {
	...
	public IronfoyjbylsbpzsssReport() {
		super();
	}

	public IronfoyjbylsbpzsssReport(String id){
		super(id);
	}
