 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzjykreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzjykReport extends DataEntity<IronfoyjbylsbpzjykReport> {
	...
	public IronfoyjbylsbpzjykReport() {
		super();
	}

	public IronfoyjbylsbpzjykReport(String id){
		super(id);
	}
