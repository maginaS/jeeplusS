 ...
 */
package com.jeeplus.modules.report.ironfofivegpszywsclreport.entity;
 ...
 * @version 2018-04-23
 */
public class IronfofivegpszywsclReport extends DataEntity<IronfofivegpszywsclReport> {
	...
	public IronfofivegpszywsclReport() {
		super();
	}

	public IronfofivegpszywsclReport(String id){
		super(id);
	}
