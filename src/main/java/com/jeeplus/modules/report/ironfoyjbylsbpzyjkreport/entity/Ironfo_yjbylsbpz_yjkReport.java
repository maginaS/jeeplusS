 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzyjkreport.entity;
 ...
 * @version 2018-04-20
 */
public class Ironfo_yjbylsbpz_yjkReport extends DataEntity<Ironfo_yjbylsbpz_yjkReport> {
	...
	public Ironfo_yjbylsbpz_yjkReport() {
		super();
	}

	public Ironfo_yjbylsbpz_yjkReport(String id){
		super(id);
	}
