 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzgrxjbkreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzgrxjbkReport extends DataEntity<IronfoyjbylsbpzgrxjbkReport> {
	...
	public IronfoyjbylsbpzgrxjbkReport() {
		super();
	}

	public IronfoyjbylsbpzgrxjbkReport(String id){
		super(id);
	}
