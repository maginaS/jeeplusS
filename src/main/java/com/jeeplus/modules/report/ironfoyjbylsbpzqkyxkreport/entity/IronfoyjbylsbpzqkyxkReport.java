 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzqkyxkreport.entity;
 ...
 * @version 2018-04-19
 */
public class IronfoyjbylsbpzqkyxkReport extends DataEntity<IronfoyjbylsbpzqkyxkReport> {
	...
	public IronfoyjbylsbpzqkyxkReport() {
		super();
	}

	public IronfoyjbylsbpzqkyxkReport(String id){
		super(id);
	}
