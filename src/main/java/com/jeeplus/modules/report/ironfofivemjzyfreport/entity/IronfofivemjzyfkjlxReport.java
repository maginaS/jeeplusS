 ...
 * @version 2018-04-23
 */
public class IronfofivemjzyfkjlxReport extends DataEntity<IronfofivemjzyfkjlxReport> {
	...
	public IronfofivemjzyfkjlxReport() {
		super();
	}

	public IronfofivemjzyfkjlxReport(String id){
		super(id);
	}
