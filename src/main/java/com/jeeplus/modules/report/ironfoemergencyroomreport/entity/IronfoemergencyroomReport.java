 ...
 */
package com.jeeplus.modules.report.ironfoemergencyroomreport.entity;
 ...
 * @version 2018-04-19
 */
public class IronfoemergencyroomReport extends DataEntity<IronfoemergencyroomReport> {
	...
	public IronfoemergencyroomReport() {
		super();
	}

	public IronfoemergencyroomReport(String id){
		super(id);
	}
