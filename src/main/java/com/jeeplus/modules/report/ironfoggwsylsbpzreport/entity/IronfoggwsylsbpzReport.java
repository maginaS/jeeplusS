 ...
 */
package com.jeeplus.modules.report.ironfoggwsylsbpzreport.entity;
 ...
 * @version 2018-04-19
 */
public class IronfoggwsylsbpzReport extends DataEntity<IronfoggwsylsbpzReport> {
	...
	public IronfoggwsylsbpzReport() {
		super();
	}

	public IronfoggwsylsbpzReport(String id){
		super(id);
	}
