 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzfskcskreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzfskcskxdtkReport extends DataEntity<IronfoyjbylsbpzfskcskxdtkReport> {
	...
	public IronfoyjbylsbpzfskcskxdtkReport() {
		super();
	}

	public IronfoyjbylsbpzfskcskxdtkReport(String id){
		super(id);
	}
