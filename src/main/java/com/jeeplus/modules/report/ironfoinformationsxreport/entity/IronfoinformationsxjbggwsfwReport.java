 ...
 * @version 2018-04-24
 */
public class IronfoinformationsxjbggwsfwReport extends DataEntity<IronfoinformationsxjbggwsfwReport> {
	...
	public IronfoinformationsxjbggwsfwReport() {
		super();
	}

	public IronfoinformationsxjbggwsfwReport(String id){
		super(id);
	}
