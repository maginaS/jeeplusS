 ...
 * @version 2018-04-24
 */
public class IronfoinformationsxjgjkReport extends DataEntity<IronfoinformationsxjgjkReport> {
	...
	public IronfoinformationsxjgjkReport() {
		super();
	}

	public IronfoinformationsxjgjkReport(String id){
		super(id);
	}
