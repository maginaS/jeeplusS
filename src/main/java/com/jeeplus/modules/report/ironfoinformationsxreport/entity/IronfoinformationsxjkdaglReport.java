 ...
 * @version 2018-04-24
 */
public class IronfoinformationsxjkdaglReport extends DataEntity<IronfoinformationsxjkdaglReport> {
	...
	public IronfoinformationsxjkdaglReport() {
		super();
	}

	public IronfoinformationsxjkdaglReport(String id){
		super(id);
	}
