 ...
 * @version 2018-04-24
 */
public class IronfoinformationsxjgyyglReport extends DataEntity<IronfoinformationsxjgyyglReport> {
	...
	public IronfoinformationsxjgyyglReport() {
		super();
	}

	public IronfoinformationsxjgyyglReport(String id){
		super(id);
	}
