 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzkqkreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzkqkReport extends DataEntity<IronfoyjbylsbpzkqkReport> {
	...
	public IronfoyjbylsbpzkqkReport() {
		super();
	}

	public IronfoyjbylsbpzkqkReport(String id){
		super(id);
	}
