 ...
 */
package com.jeeplus.modules.report.ironfojhsybylsbpzreport.entity;
 ...
 * @version 2018-04-19
 */
public class IronfojhsybylsbpzReport extends DataEntity<IronfojhsybylsbpzReport> {
	...
	public IronfojhsybylsbpzReport() {
		super();
	}
	...
	public IronfojhsybylsbpzReport(String id){
		super(id);
	}
