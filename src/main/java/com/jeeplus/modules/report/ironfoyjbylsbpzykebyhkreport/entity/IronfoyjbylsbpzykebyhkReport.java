 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzykebyhkreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzykebyhkReport extends DataEntity<IronfoyjbylsbpzykebyhkReport> {
	...
	public IronfoyjbylsbpzykebyhkReport() {
		super();
	}

	public IronfoyjbylsbpzykebyhkReport(String id){
		super(id);
	}
