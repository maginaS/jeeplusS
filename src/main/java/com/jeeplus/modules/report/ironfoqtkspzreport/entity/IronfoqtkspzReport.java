 ...
 */
package com.jeeplus.modules.report.ironfoqtkspzreport.entity;
 ...
 * @version 2018-04-19
 */
public class IronfoqtkspzReport extends DataEntity<IronfoqtkspzReport> {
	...
	public IronfoqtkspzReport() {
		super();
	}

	public IronfoqtkspzReport(String id){
		super(id);
	}
