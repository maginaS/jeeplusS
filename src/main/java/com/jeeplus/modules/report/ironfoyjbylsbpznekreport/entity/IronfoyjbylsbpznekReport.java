 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpznekreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpznekReport extends DataEntity<IronfoyjbylsbpznekReport> {
	...
	public IronfoyjbylsbpznekReport() {
		super();
	}

	public IronfoyjbylsbpznekReport(String id){
		super(id);
	}
