 ...
 */
package com.jeeplus.modules.report.ironfoyjbylsbpzxdgysreport.entity;
 ...
 * @version 2018-04-20
 */
public class IronfoyjbylsbpzxdgysReport extends DataEntity<IronfoyjbylsbpzxdgysReport> {
	...
	public IronfoyjbylsbpzxdgysReport() {
		super();
	}

	public IronfoyjbylsbpzxdgysReport(String id){
		super(id);
	}
