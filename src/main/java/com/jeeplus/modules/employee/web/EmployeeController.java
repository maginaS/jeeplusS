 ...
 */
package com.jeeplus.modules.employee.web;
...
import com.jeeplus.modules.employee.service.EmployeeService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sys/user/scccccccc")
...
//		try {
//            String fileName = "员工管理"+DateUtils.getDate("yyyyMMddHHmmss")+".xlsx";
//            Page<Employee> page = employeeService.findPage(new Page<Employee>(request, response, -1), employee);
//    		new ExportExcel("员工管理", Employee.class).setDataList(page.getList()).write(response, fileName).dispose();
//    		return null;
//		} catch (Exception e) {
//			addMessage(redirectAttributes, "导出员工管理记录失败！失败信息："+e.getMessage());
//		}
//		return "redirect:"+Global.getAdminPath()+"/employee/employee/?repage";
//    }
//
...
//			}
//			if (failureNum>0){
//				failureMsg.insert(0, "，失败 "+failureNum+" 条员工管理记录。");
//			}
//			addMessage(redirectAttributes, "已成功导入 "+successNum+" 条员工管理记录"+failureMsg);
//		} catch (Exception e) {
//			addMessage(redirectAttributes, "导入员工管理失败！失败信息："+e.getMessage());
//		}
//		return "redirect:"+Global.getAdminPath()+"/employee/employee/?repage";
//    }
//	
...
//    public String importFileTemplate(HttpServletResponse response, RedirectAttributes redirectAttributes) {
//		try {
//            String fileName = "员工管理数据导入模板.xlsx";
//    		List<Employee> list = Lists.newArrayList(); 
//    		new ExportExcel("员工管理数据", Employee.class, 1).setDataList(list).write(response, fileName).dispose();
//    		return null;
//		} catch (Exception e) {
//			addMessage(redirectAttributes, "导入模板下载失败！失败信息："+e.getMessage());
//		}
