...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="ironfozyb" action="${ctx}/ironfozyb/ironfozyb/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="zyb_sbmc" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">品牌：</label></td>
					<td class="width-35">
						<form:input path="zyb_pp" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">型号：</label></td>
					<td class="width-35">
						<form:input path="zyb_xh" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">数量（台/个）：</label></td>
					<td class="width-35">
						<form:input path="zyb_sl" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">设备价格（元）：</label></td>
					<td class="width-35">
						<form:input path="zyb_sbjg" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">投入使用年份：</label></td>
					<td class="width-35">
						<form:input path="zyb_trsynf" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
		 	</tbody>
		</table>
