...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="ironfofiventzyxjzl" action="${ctx}/ironfofiventzyxjzl/ironfofiventzyxjzl/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<textarea path="remarks" htmlEscape="false" rows="4"    class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:radiobuttons path="zykt" items="${fns:getDictList('')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks "/>
					</td>
