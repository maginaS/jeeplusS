...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="ironfofivezgshyf" action="${ctx}/ironfofivezgshyf/ironfofivezgshyf/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">职工宿舍：</label></td>
					<td class="width-35">
						<form:radiobuttons path="zgss" items="${fns:getDictList('')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks "/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">自饮食堂：</label></td>
					<td class="width-35">
						<form:radiobuttons path="zyst" items="${fns:getDictList('')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks "/>
					</td>
				</tr>
				<tr>
