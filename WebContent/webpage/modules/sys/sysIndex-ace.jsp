				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
						<small>
							...
							<img src="${ctxStatic }/common/login/images/ie6/LOGO.png" style="height:46px;">
							调研管理系统
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
						<!-- <button class="btn btn-success"  onclick="document.getElementById('inputForm_test').submit();"> -->
<!-- 						<input type="button" value="提交" onclick="document.getElementById('inputForm_test').submit();">
 -->						<!-- 	保存 -->
