    ...
    border-radius: 40px;
		...
		<script type="text/javascript">
				$(document).ready(function() {
				 ...
				 /* alert();  */
				 	/* alert("111111111111111111111---->"+"${pageContext.request.contextPath}"); */
					$("#loginForm").validate({
						rules: {
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="center">
								<h1>
									<br/>
									<img src="${ctxStatic }/common/login/images/ie6/LOGO.png" style="width:200px">
									<br>
								</h1>
												...
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-35 pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">登录</span><!-- onclick="alert();" -->
														</button>
													</div>
