...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="ironfofeatdepartment" action="${ctx}/ironfofeatdepartmenttestreport/ironfofeatdepartment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="tsks" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">2017年门诊人次数（人次）：</label></td>
					<td class="width-35">
						<form:input path="nmzrcs" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">2017年出院人数（人）：</label></td>
					<td class="width-35">
						<form:input path="ncyrs" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">科室实有床位(张)：</label></td>
					<td class="width-35">
						<form:input path="kssycw" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">科室执业(助理)医师（人）：</label></td>
					<td class="width-35">
						<form:input path="kszyzlys" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">科室注册护士（人）：</label></td>
					<td class="width-35">
						<form:input path="kszchs" htmlEscape="false"    class="form-control "/>
					</td>
