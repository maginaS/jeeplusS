...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="ironfopopulation" action="${ctx}/ironfopopulation/ironfopopulation/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="population_zjzmj" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">地下建筑面积（m2）：</label></td>
					<td class="width-35">
						<form:input path="population_dxjzmj" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">单体建筑数量（栋）：</label></td>
					<td class="width-35">
						<form:input path="population_dtjzsl" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">建筑高度24m以上的单体建筑数量（m）：</label></td>
					<td class="width-35">
						<form:input path="population_jzgd" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
		 	</tbody>
		</table>
